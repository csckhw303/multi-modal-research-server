...
**Step 2 — for everything else, treat it as a document question:**
...
**Never answer a substantive question without first querying the RAG tool. This ensures every response is grounded in project-specific context and documentation.**
"""
